...
Ie(t_plot>= 30 & t_plot<= 40) = 3; % (uA/cm^2)

%%% square pulse of current starts at 50 ms and ends at 60 ms
%Ie(t_plot>= 50 & t_plot<= 60) = 3; % (uA/cm^2)

%%% square pulse of current starts at 42 ms and ends at 52 ms
Ie(t_plot>= 42 & t_plot<= 52) = 3; % (uA/cm^2)
